...
{
public:
	MenuState(GameApp* app) : GameState(app), m_app(app), m_map(0), Background(0), Objects(0)
	{
		...
		GameObject* startButtonObject = createSpriteGameObject("../assets/buttons.png", tileSize.x, tileSize.y, 0, 0, 242, 96, true);
		...
		GameObject* exitButtonObject = createSpriteGameObject("../assets/buttons.png", tileSize.x, tileSize.y, 242, 0, 242, 96, true);
	...
	GameObject* MenuState::createSpriteGameObject(const std::string& bitmapFileName, float sizeX, float sizeY, bool isWhiteTransparentColor = false)
	{
